...
CelBuilder.addInstructions([
    ...
    CelBuilder.atInterval(1000, 0, [ // calculate game of life every "n" msecs
        CelBuilder.forEachPixel(0, [ // memory bank 0 -> index of loop
            ...
            CelBuilder.ifGreaterThan(1,0, 17, 3, [
                CelBuilder.modifyPixel(0,1, [0,0,0,0])
            ]),
            ...
            // new born!!!
            CelBuilder.ifEquals(1,0, 17, 3, [
                CelBuilder.modifyPixel(0,1, [0,0,0, 255])
            ])
