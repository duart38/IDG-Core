...
export enum RGBConversionType {
  ...
  // RGB_TO_COLOR_REG_REG_MEM,
  // RGB_TO_COLOR_MEM_REG_REG,
  // RGB_TO_COLOR_MEM_MEM_REG,
  // RGB_TO_COLOR_REG_MEM_REG,
  // RGB_TO_COLOR_MEM_REG_MEM,

  // RGB_TO_COLOR_LIT_MEM_MEM,
  // RGB_TO_COLOR_LIT_LIT_MEM,
  // RGB_TO_COLOR_MEM_LIT_LIT,
  // RGB_TO_COLOR_MEM_MEM_LIT,
  // RGB_TO_COLOR_MEM_LIT_MEM,
}
