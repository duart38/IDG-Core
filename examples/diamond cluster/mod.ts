...
CelBuilder.addInstructions([
    ...
    CelBuilder.atInterval(900, 0, 81, [
        ...randomGliderDown,
    ...
    CelBuilder.atInterval(100, 0, -1, [ // calculate game of life every "n" msecs
        CelBuilder.forEachPixel(0, [ // memory bank 0 -> index of loop
            ...
            CelBuilder.allTrue([
                ...
                CelBuilder.modifyPixel(1, 0, [255,255,255,241]) // index stored in memory bank 0 is loaded.
            ]),
